   ...
   isset($_POST['date_of_birth'])) {
    ...
    // NEW COLUMNS ADDED DUE TO SECTION TABLE 
      ...
      exit;
        ...
        $sql = "INSERT INTO
                registrar_office(username, password, fname, lname,
                            address,
                            employee_number, date_of_birth, phone_number,
                            qualification, gender, email_address)
                            VALUES(?,?,?,?,?,?,?,?,?,?,?)"; // 11  -- DON'T FORGET TO UPDATE THIS FUNCTION WHEN MODIFYING THE QUERY!
        ...
        $stmt->execute([$uname, $hashedpass, $fname, $lname, 
              ...
              $sm = "New User has been added successfully";
